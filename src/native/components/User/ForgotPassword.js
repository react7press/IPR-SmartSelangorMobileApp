      ...
      <Container>
        <Content padder>
          <Header
            ...
            content="Masukkan alamat e-mel yang telah anda daftar untuk akaun dan klik pautan 'tetapkan semula kata laluan' anda."
          />
          ...
          <Form>
            ...
            <Button block onPress={this.handleSubmit} disabled={loading}>
              <Text>{loading ? 'Loading' : 'Tetapkan Semula'}</Text>
            </Button>
          </Form>
        </Content>
      </Container>
